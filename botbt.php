...
session_start();
require 'cauhinh1.php';
if(isset($_SESSION['botbt']) && isset($_POST['web']) && isset($_POST['page']) && isset($_POST['dbhost']) && isset($_POST['dbuser']) && isset($_POST['dbpass']) && isset($_POST['dbname'])){
  echo 'ok';
  $ConfigFile = fopen("cauhinh1.php", "w") or die("Không thể khởi tạo file này!");
  $ConfigContent = '<?php
...
<div class="row">
  ...
  <button id="botbt" type="button" class="btn btn-warning btn-fill">Cập nhật cấu hình</button>
  </div>
  </form>
<?php else: ?>
  <form class="form-horizontal" method="POST">
